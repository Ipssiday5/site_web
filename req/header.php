        ...
        <div class="classy-nav-container breakpoint-off">
            <div class="container">
                ...
                <nav class="classy-navbar justify-content-between" id="conferNav">
                    ...
                    <!-- Logo -->
                    <a class="nav-brand" href="./index.html?go=accueil"><img src="./img/core-img/logo.png" alt=""></a>
                    ...
                    <div class="classy-menu">
                        ...
                        <div class="classynav">
                            ...
                            <!-- Get Tickets Button -->
                            <a href="index.php?go=ticket" class="btn confer-btn mt-3 mt-lg-0 ml-3 ml-lg-5">Les Tickets <i class="zmdi zmdi-long-arrow-right"></i></a>
                          </div>
                        <!-- Nav End -->
                    </div>
                </nav>
