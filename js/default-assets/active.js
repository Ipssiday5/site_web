(function ($) {
    ...
    if ($.fn.countdown) {
        $("#clock").countdown("2020/06/25", function (event) {
            $(this).html(event.strftime("<div>%m <span>Mois</span></div> <div>%d <span>Jours</span></div> <div>%H <span>Heures</span></div> <div>%M <span>Minutes</span></div> <div>%S <span>Secondes</span></div>"));
        });
    }
